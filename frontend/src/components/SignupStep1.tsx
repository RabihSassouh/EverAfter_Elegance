        ...
        <div className='absolute w-[80%] md:w-[45%] h-full md:left-20 z-10 flex items-center justify-center'>
          <div className='bg-white h-[80%] md:p-10 rounded-xl flex flex-col items-center justify-center'>
            ...
            <div className='flex flex-col w-full'>
              <button className={`mb-4 bg-primary  font-poppins text-[#FFFFFFEB] font-semibold px-6 py-2 rounded hover:shadow-md transition-colors`}>Couple</button>
              <button className={`mb-4 bg-primary  font-poppins text-[#FFFFFFEB] font-semibold px-6 py-2 rounded hover:shadow-md transition-colors`}>Business owner</button>
            </div>
          </div>
        </div>
