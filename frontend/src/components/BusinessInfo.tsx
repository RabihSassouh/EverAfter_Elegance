...
const BusinessInfo: React.FC = () => {
  ...
  const handleNext = async () => {
    ...
    try {
      ...
      for (let [key, value] of businessInfoFormData.entries()) {
        business_information[key as keyof BusinessInformationFormData] =
          value as string;
      }
      await BusinessInformationSchema.validate(business_information, {
        abortEarly: false,
      });
  ...
  return (
    <div className="min-h-screen flex items-center justify-center py-6 px-12 bg-white">
      <div className="container max-w-4xl mx-auto">
        <form action="" ref={businessInfoForm}>
          <div className="mb-5 flex flex-col gap-8">
            ...
            <textarea
              name="description"
              id=""
              className="border-[1px] border-gray-600 w-full rounded-xl h-44 font-poppins px-4 py-2"
            ></textarea>
          </div>
            ...
            <div className="flex flex-col md:h-52 md:flex-row gap-8 items-center justify-between">
              <div className="flex flex-col gap-4 h-full items-center justify-between">
                <input
                  name="company_name"
                  type="text"
                  className="border-[1px] border-gray-600 rounded-xl font-poppins px-4 py-2 placeholder:font-poppins"
              ...
              <textarea
                name="facilities"
                id=""
                className="w-full md:w-auto h-28 md:h-full border-[1px] border-gray-600 rounded-xl font-poppins px-4 py-2 placeholder:font-poppins placeholder:text-center"
        ...
        <div className="flex w-full items-end justify-end">
          <button
            className="bg-primary  font-poppins text-[#FFFFFFEB] font-semibold px-6 py-2 rounded-full hover:bg-secondary hover:shadow-md transition-colors"
            onClick={handleNext}
          >
            Next
          </button>
